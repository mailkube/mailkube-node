...
`mailkube-node` follows [Semantic Versioning](https://semver.org/). Security
...
[**"Report a vulnerability"**](https://github.com/mailkube/mailkube-node/security/advisories/new)
