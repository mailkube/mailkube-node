...
// or `bun add ./mailkube-*.tgz`), so `"mailkube"` is a BARE SPECIFIER resolved through the exports
// map. Never `npm:mailkube`: in Deno that is a registry fetch, which would 404 before the first
...
import manifest from "mailkube/package.json" with { type: "json" };
